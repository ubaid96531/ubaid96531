...
**Languages:**
```
C++ │ Python │ JavaScript (Node.js) │ SQL │ x86 Assembly
```

**Web & Frameworks:**
```
HTML │ CSS │ Express.js │ Bootstrap │ JWT │ SSE
```

**AI & Robotics:**
```
YOLO │ OpenCV │ ROS2 │ LLM APIs │ Data Visualization
```

**Systems & Hardware:**
```
Linux (Ubuntu/WSL) │ ESP32 │ Arduino │ Raspberry Pi │ LiDAR
```
